...
require (
	...
	knative.dev/operator v0.41.2-0.20240521015912-2f7518e862a7
...
replace (
	// Knative components
	knative.dev/eventing => github.com/openshift-knative/eventing v0.99.1-0.20240508095436-d1779816fd34
